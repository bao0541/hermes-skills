...
| 进场确认 | 翻转后等一根K线确认，不是一翻就冲 |
| 初始仓位 | 0.1 ETH (~$220) |
| 止盈 | 2% |
| 止损 | 2% |
| 翻倍补仓 | ✅ 止损后下次开仓翻倍（0.1→0.2→0.4） |
| 翻倍上限 | **最多3次连败**，再止损就停手等下一轮信号 |
| 大周期过滤 | 日线 SuperTrend 方向一致才开仓 |
| 目标 | 先验证策略本身能不能赚钱，不加杠杆干扰 |

> 参考来源：朋友实战参数优化版。原版为单周期 SuperTrend 翻转+翻倍马丁格尔，加入了大周期过滤、翻倍上限、K线确认三层风控。
